...
namespace AluguelCarro.Controllers {
    public class NiveisAcessosController : Controller {
        ...
        public NiveisAcessosController(INivelAcessoRepository nivelAcessoRepository, ILogger<NiveisAcessosController> logger) {
        ...
        public async Task<IActionResult> Index() {
            ...
            return View(await _nivelAcessoRepository.PegarTodos().ToListAsync());
            }


        public IActionResult Create() {
            _logger.LogInformation("iniciando a criacao de niveis de acesso");
            return View();
            }
        ...
        public async Task<IActionResult> Create([Bind("Descricao,Name")] NiveisAcesso niveisAcesso) {
            if(ModelState.IsValid) {
                _logger.LogInformation("Verificando se nivel de acesso existe");
                bool nivelExiste = await _nivelAcessoRepository.NivelAcessoExiste(niveisAcesso.Name);

                if(!nivelExiste) {
                    niveisAcesso.NormalizedName = niveisAcesso.Name.ToUpper();
                    await _nivelAcessoRepository.Inserir(niveisAcesso);
        ...
        public async Task<IActionResult> Edit(string id) {
            ...
            var niveisAcesso = await _nivelAcessoRepository.PegarPeloId(id);
        ...
        public async Task<IActionResult> Edit(string id, [Bind("Descricao,Id,Name,NormalizedName,ConcurrencyStamp")] NiveisAcesso niveisAcesso) {
            ...
            if(ModelState.IsValid) {
                ...
                niveisAcesso.NormalizedName = niveisAcesso.Name.ToUpper();
                await _nivelAcessoRepository.Atualizar(niveisAcesso);
        ...
        public async Task<IActionResult> Delete(string id) {
            await _nivelAcessoRepository.Excluir(id);
